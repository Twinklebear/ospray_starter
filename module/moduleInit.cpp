...
#include "geometry/ExampleSpheres.h"
...
extern "C" OSPError OSPRAY_DLLEXPORT ospray_module_init_example_spheres(
    int16_t versionMajor, int16_t versionMinor, int16_t /*versionPatch*/)
{
  ...
  if (status == OSP_NO_ERROR) {
    /*! maybe one of the most important parts of this example: this
        function 'registers' the ExampleSpheres class under the ospray
        ...
        with; i.e.,
    */
    Geometry::registerType<ExampleSpheres>("example_spheres");
  }
